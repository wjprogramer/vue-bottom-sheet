    ...
    <div class="container pt-5 pb-5">
        ...
        <div class="col-md-4 col-12">
          ...
          <div class="form-group mb-3">
            ...
            >
              ...
              <option selected value="fx-slide-from-right">fx-slide-from-right</option>
              <option selected value="fx-slide-from-left">fx-slide-from-left</option>
            </select>
          </div>
        </div>
      </div>
      ...
      >
        <div class="sheet-content">
          <h1>Lorem Ipsum</h1>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime neque sed
            tempore ullam. Accusamus animi at autem beatae est, hic inventore iste minima,
            non quibusdam quisquam quos velit veritatis voluptatem?
          </p>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Maxime neque sed
            tempore ullam. Accusamus animi at autem beatae est, hic inventore iste minima,
          ...
          <h2>Lorem Ipsum</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Animi excepturi
            explicabo id illum magnam possimus provident quae recusandae rerum tempore. Ab
            adipisci beatae, distinctio ea nemo omnis sed similique veniam.
          </p>
...
export default defineComponent({
  ...
  data () {
    ...
    const overlyHexColor = computed(() => {
      if (overlayColorSelect.value != null) {
        return overlayColorSelect.value.hex8
      }
      return undefined
    })
    ...
    return {
      ...
      maxWidth: ref('640px'),
      maxHeight: ref('90%'),
      clickToClose: ref(true),
      effect: ref('fx-default'),
      rounded: ref(true),
      swipeAble: ref(true),
